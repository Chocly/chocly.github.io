          ...
          <div className="profile-header-main">
            ...
            <div className="profile-info">
              ...
              <div className="follow-stats">
                ...
                <span className="follow-stat-divider">·</span>
                <span className="follow-stat" onClick={() => setActiveTab('following')} style={{ cursor: 'pointer' }}>
...
<div className="profile-nav">
  ...
  <button
    className={`profile-nav-link ${activeTab === 'following' ? 'active' : ''}`}
            ...
            <div className="following-tab">
              ...
              {loading ? (
                  ...
                  {followingList.map(user => (
                    ...
                    >
                      ...
                      <div className="following-info">
                        <span className="following-name">{user.displayName || 'User'}</span>
                        {user.bio && <span className="following-bio">{user.bio}</span>}
                        {user.reviewCount > 0 && (
                          <span className="following-reviews">{user.reviewCount} reviews</span>
                        )}
                      </div>
                    </Link>
                  ))}
                ...
                <div className="empty-state">
                  ...
                  <p>Discover other chocolate lovers by exploring reviews and profiles!</p>
