...
import '../src/views/HomePage-new.css';
    ...
    <div className="hp-page">
      <section className="hp-hero">
        <div className="hp-hero-inner">
          <h1 className="hp-hero-title">Discover your next favorite chocolate</h1>
          <p className="hp-hero-subtitle">
            Rate, review, and explore craft chocolate from around the world.
            Build your palate. Find your favorites.
          </p>
          <div className="hp-hero-actions">
            <Link href="/auth" className="hp-btn-primary">Get Started Free</Link>
            <Link href="/browse" className="hp-btn-ghost">Browse Chocolates</Link>
          </div>
        </div>
      ...
      <section className="hp-featured">
        <div className="hp-section-header">
          ...
          <Link href="/browse" className="hp-section-link">View all &rarr;</Link>
        </div>
      ...
      <section className="hp-how">
        ...
        <div className="hp-steps">
          <div className="hp-step">
            ...
            <p className="hp-step-desc">Search our database or scan a bar to find it instantly.</p>
          </div>
          <div className="hp-step">
            <span className="hp-step-number">2</span>
            <h3 className="hp-step-name">Rate & Review</h3>
            <p className="hp-step-desc">Score it, add tasting notes, and upload a photo of your bar.</p>
          </div>
          <div className="hp-step">
            <span className="hp-step-number">3</span>
            <h3 className="hp-step-name">Get Recommendations</h3>
            <p className="hp-step-desc">Discover new chocolates tailored to your taste profile.</p>
          </div>
        </div>
      </section>
      ...
      <section className="hp-cta">
        ...
        <Link href="/auth" className="hp-btn-primary hp-btn-primary--large">
          Get Started Free
        </Link>
        <p className="hp-cta-signin">
          Already have an account? <Link href="/auth" className="hp-cta-signin-link">Sign in</Link>
        </p>
      </section>
    </div>
  );
